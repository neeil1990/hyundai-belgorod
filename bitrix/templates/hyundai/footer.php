...
<script src="<?=SITE_TEMPLATE_PATH?>/js/index/header.js"></script>
...
<script type="text/javascript" src="<?=SITE_TEMPLATE_PATH?>/js/index/swq.js"></script>
<!-- /StreamWood code -->

<!-- Yandex.Metrika counter -->
<script type="text/javascript" src="<?=SITE_TEMPLATE_PATH?>/js/index/ym.js"></script>
...
<!-- calltouch -->
<script type="text/javascript" src="<?=SITE_TEMPLATE_PATH?>/js/index/calltouch.js"></script>
<!-- calltouch -->
