...
$APPLICATION->SetPageProperty("title", "Хендай Туссан купить в Белгороде, цены и комплектации нового Hyundai Tucson - Хенде Ринг Авто");
$APPLICATION->SetPageProperty("description", "Купить Хендай Туксон на сайте официального дилера в Белгороде, посмотрите комплектации и цены нового автомобиля Hyundai Tucson");
$APPLICATION->SetTitle("Новый TUCSON.");
?><span>
<div class="content">
	 <script src="https://api-maps.yandex.ru/2.1/?apikey=ffa519d3-303f-463c-afa2-29eec493cd33&lang=ru_RU" type="text/javascript"></script> <section class="nav">
	<ul class="nav__menu">
		...
		Характеристики </a> </li>
		<li class="nav__item"> <a target="_blank" href="https://www.hyundai.ru/NewTucson/gallery" class="nav__link">
		Галерея </a> </li>
	</ul>
	<div class="nav__buttons">
 <a target="_blank" href="/test-drive/Tucson" class="df-button nav__button js-open-p-td">
		Тест-драйв </a> <a target="_blank" href="/configurator/car/26" class="df-button nav__button">
		Конфигуратор </a> <a target="_blank" href="/find-dealer" class="df-button nav__button">
		Найти дилера </a>
	</div>
 </section> <section class="banner section section--big lazypreview lazyload" data-bgset="/images/cars/tucson/m_pics/title.jpg [(max-width: 640px)] | /images/cars/tucson/pics/title.jpg">
	<div class="banner__head">
		<h1 class="banner__title">
		Новый Hyundai TUCSON.</h1>
		<div class="banner__subtitle h3">
			 Везет тому, кто ведет!
		</div>
	</div>
 ...
 <a href="#view360" class="js-next-slide banner__circle scroll"></a>
	...
	<ul class="s-parallax__list s-parallax__list--left">
		...
		<div data-bgset="/images/cars/tucson/m_pics/design_1a.jpg [(max-width: 640px)] | /images/cars/tucson/pics/design_2a.jpg" class="s-parallax__bg0 lazyload lazypreview">
		</div>
		<div data-bgset="/images/cars/tucson/m_pics/design_1b.jpg [(max-width: 640px)] | /images/cars/tucson/pics/design_2b.jpg" class="s-parallax__bg lazyload lazypreview">
		</div>
		<div data-bgset="/images/cars/tucson/m_pics/design_1c.jpg [(max-width: 640px)] | /images/cars/tucson/pics/design_2c.jpg" class="s-parallax__bg lazyload lazypreview">
		</div>
		<div class="s-parallax__description s-parallax__description--black">
 <span>17,&nbsp;18&nbsp;или 19-дюймовые<br>
			 легкосплавные диски</span> добавляют образу TUCSON динамики и&nbsp;индивидуальности.
		</div>
 </li>
		...
		<div class="s-parallax__description s-parallax__description--black-mob">
			 Светодиодные задние фонари увеличивают видимость и&nbsp;покоряют своим внешним видом.
		</div>
 </li>
	</ul>
	<ul class="s-parallax__list s-parallax__list--right">
		...
		<div class="s-parallax__description">
			 Панорамная крыша с&nbsp;люком дарит чувство открытого пространства, создавая особую атмосферу в&nbsp;салоне автомобиля.
		</div>
 </li>
	</ul>
 </section> <section id="dynamics" class="section dynamics dynamics--1 view0">
	<div class="dynamics__back lazyload lazypreview" data-bgset="/images/cars/tucson/m_pics/performance_2.jpg">
	</div>
	<div class="dynamics__head">
		...
		<div class="dynamics__wrap">
			<ul class="dynamics__tabs">
				...
				2.0 MPI </a> </li>
				<li class="dynamics__tab dynamics__tab--right"> <a data-view="view1" href="#" class="dynamics__link js-change-view">
				1.6 T-GDi </a> </li>
				<li class="dynamics__tab"> <a data-view="view2" href="#" class="dynamics__link js-change-view">
				2.0 Diesel </a> </li>
			</ul>
		</div>
	</div>
	...
	<div data-bgset="/images/cars/tucson/m_pics/performance_3.jpg [(max-width: 640px)] | /images/cars/tucson/pics/performance_1.jpg" class="s-parallax__bg0 lazyload lazypreview">
	</div>
	<div class="dynamics__head">
 ...
 <img src="/images/cars/tucson/svg/performance_1.svg">
	...
	<ul class="s-parallax__list s-parallax__list--left">
		...
		<div data-bgset="/images/cars/tucson/m_pics/comfort_2a.jpg [(max-width: 640px)] | /images/cars/tucson/pics/comfort_5a.jpg" class="s-parallax__bg0 lazyload lazypreview">
		</div>
		<div data-bgset="/images/cars/tucson/m_pics/comfort_2b.jpg [(max-width: 640px)] | /images/cars/tucson/pics/comfort_5b.jpg" class="s-parallax__bg lazyload lazypreview">
		</div>
		<div class="s-parallax__description">
			 Цвет интерьера и&nbsp;отделка на&nbsp;ваш выбор: чёрный или бежевый, ткань или кожа.
		</div>
 </li>
		...
		<div class="s-parallax__description">
			 Красочная и&nbsp;информативная панель приборов с&nbsp;4.2-дюймовым дисплеем подсказывает водителю всю необходимую информацию.
		</div>
 </li>
	</ul>
	<ul class="s-parallax__list s-parallax__list--right">
		...
		<div class="s-parallax__description">
			 В багажник обновлённого TUCSON помещается всё, что может пригодиться в&nbsp;дороге.
		</div>
 </li>
	</ul>
	...
	<div data-bgset="/images/cars/tucson/pics/side_1.png" class="lazyload lazypreview safety__back safety__back--1">
	</div>
 ...
 <img src="/images/cars/tucson/svg/tech_1.svg">
	...
	<div class="s-beep">
		<div class="schema">
 <img src="null" data-src="/images/cars/tucson/pics/schem/scheme_1.jpg" alt="">
		</div>
 ...
 <img src="null" data-src="/images/cars/tucson/pics/schem/scheme_1_1.jpg" alt=""> <img src="null" class="schema__animate" data-src="/images/cars/tucson/pics/schem/scheme_1_2.jpg" alt=""> <img src="null" class="schema__animate" data-src="/images/cars/tucson/pics/schem/scheme_1_3.jpg" alt=""> <img src="null" class="schema__animate" data-src="/images/cars/tucson/pics/schem/scheme_1_4.jpg" alt=""> <img src="null" class="schema__animate" data-src="/images/cars/tucson/pics/schem/scheme_1_5.jpg" alt=""> <img src="null" class="schema__animate" data-src="/images/cars/tucson/pics/schem/scheme_1_6.jpg" alt=""> <img src="null" class="schema__animate" data-src="/images/cars/tucson/pics/schem/scheme_1_7.jpg" alt=""> <img src="null" class="schema__animate" data-src="/images/cars/tucson/pics/schem/scheme_1_8.jpg" alt=""> <img src="null" class="schema__animate" data-src="/images/cars/tucson/pics/schem/scheme_1_9.jpg" alt=""> <img src="null" class="schema__animate" data-src="/images/cars/tucson/pics/schem/scheme_1_10.jpg" alt=""> <img src="null" class="schema__animate" data-src="/images/cars/tucson/pics/schem/scheme_1_11.jpg" alt=""> <img src="null" class="schema__animate" data-src="/images/cars/tucson/pics/schem/scheme_1_12.jpg" alt=""> <img src="null" class="schema__animate" data-src="/images/cars/tucson/pics/schem/scheme_1_13.jpg" alt=""> <img src="null" class="schema__animate" data-src="/images/cars/tucson/pics/schem/scheme_1_14.jpg" alt=""> <img src="null" class="schema__animate" data-src="/images/cars/tucson/pics/schem/scheme_1_15.jpg" alt=""> <img src="null" class="schema__animate" data-src="/images/cars/tucson/pics/schem/scheme_1_16.jpg" alt=""> <img src="null" class="schema__animate" data-src="/images/cars/tucson/pics/schem/scheme_1_17.jpg" alt=""> <img src="null" class="schema__animate" data-src="/images/cars/tucson/pics/schem/scheme_1_18.jpg" alt=""> <img src="null" class="schema__animate" data-src="/images/cars/tucson/pics/schem/scheme_1_19.jpg" alt=""> <img src="null" class="schema__animate" data-src="/images/cars/tucson/pics/schem/scheme_1_20.jpg" alt=""> <img src="null" class="schema__animate" data-src="/images/cars/tucson/pics/schem/scheme_1_21.jpg" alt="">
		</div>
	...
	<div class="s-back">
		<div class="s-back__img">
			<div class="schema">
 <img src="null" data-src="/images/cars/tucson/pics/schem/scheme_3.jpg" alt="">
			</div>
		</div>
		<div class="s-back__description">
			<div class="safety__title">
 ...
 <img src="/images/cars/tucson/svg/tech_3.svg">
	...
	<ul class="s-parallax__list s-parallax__list--left">
		<li class="s-parallax__item s-parallax__item--50 lazyload lazypreview" data-order="1" data-bgset="/images/cars/tucson/m_pics/tech_3.jpg [(max-width: 640px)] | /images/cars/tucson/pics/tech_2.jpg"> <img src="/images/cars/tucson/pics/tech_2_logo.png" alt="" class="s-parallax__icon">
		<div class="s-parallax__description s-parallax__description--black">
 <span>Прочный кузов и 6 подушек<br>
			 безопасности</span> обеспечивают надёжную защиту для водителя и&nbsp;пассажиров - TUCSON получил 5&nbsp;звёзд по&nbsp;результатам теста EURO NCAP.
		</div>
 </li>
		...
		<div class="s-parallax__description">
			 Камера заднего вида помогает водителю полностью контролировать ситуацию во&nbsp;время парковки.
		</div>
 </li>
		...
		<div class="s-parallax__description s-parallax__description--black">
			 Система удержания в полосе движения предупреждает водителя о&nbsp;пересечении линии разметки и&nbsp;подруливает в&nbsp;случае необходимости.
		</div>
 </li>
		...
		<div class="s-parallax__description s-parallax__description--black">
			 Адаптивный круиз-контроль контролирует расстояние до&nbsp;движущегося впереди автомобиля, автоматически ускоряя или замедляя ход.
		</div>
 </li>
	</ul>
	<ul class="s-parallax__list s-parallax__list--right">
		...
		<div class="s-parallax__description s-parallax__description--black">
			 В тёмное время суток система автоматически переключает дальний свет на&nbsp;ближний при обнаружении автомобиля, двигающегося по&nbsp;встречной полосе.
		</div>
 </li>
		...
		<div class="s-parallax__description">
			 С функцией автоматического открывания двери багажника погрузка в&nbsp;автомобиль остаётся легкой, даже если у&nbsp;вас заняты руки.
		</div>
 </li>
		...
		<div class="s-parallax__description">
			 Система динамической стабилизации сохраняет устойчивость и&nbsp;управляемость автомобиля, предотвращая критические ситуации.
		</div>
 </li>
	</ul>
