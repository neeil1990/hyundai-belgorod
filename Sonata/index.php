...
$APPLICATION->SetPageProperty("description", "Купить Хендай Соната на сайте официального дилера в Белгороде, посмотрите комплектации и цены нового автомобиля Hyundai Sonata в каталоге");
$APPLICATION->SetPageProperty("title", "Хендай Соната купить в Белгороде, цена на Hyundai Sonata в каталоге Хенде Ринг Авто");
...
<div class="content">
	...
	<ul class="nav__menu">
		...
		Характеристики </a> </li>
		<li class="nav__item"> <a target="_blank" href="https://www.hyundai.ru/Sonata/gallery" class="nav__link">
		Галерея </a> </li>
	</ul>
	<div class="nav__buttons">
 <a target="_blank" href="/test-drive/Sonata" class="df-button nav__button js-open-p-td">
		Тест-драйв </a> <a target="_blank" href="/configurator/car/24" class="df-button nav__button">
		Конфигуратор </a> <a target="_blank" href="/find-dealer" class="df-button nav__button">
		Найти дилера </a>
	</div>
 </section> <section class="banner section section--big lazyload lazypreview" data-bgset="/images/cars/sonata/m_pics/01_title/title.jpg [(max-width: 640px)] | /images/cars/sonata/pics/title.jpg">
	<div class="banner__head">
		<h1 class="banner__title">Hyundai SONATA. </h1>
 ...
 <a href="#view360" class="js-next-slide banner__circle scroll"></a>
	...
	<ul class="s-parallax__list s-parallax__list--left">
		...
		<div class="s-parallax__description">
			 Интеллектуальная система открывания багажника. Достаточно поднести к автомобилю ключ Smart Key, и багажник откроется автоматически.
		</div>
 </li>
	</ul>
	<ul class="s-parallax__list s-parallax__list--right">
		...
		<div class="s-parallax__description">
			 Выхлопная система с двумя глушителями подчёркивает динамические возможности автомобиля, акцентируя его спортивный характер.
		</div>
 </li>
	...
	<div class="dynamics__back dynamics__back--view0 lazyload lazypreview" data-bgset="/images/cars/sonata/m_pics/03_performance/performance_slider_1.jpg [(max-width: 640px)] | /images/cars/sonata/tablet/performance_slider_1.jpg">
	</div>
	<div class="dynamics__back dynamics__back--view1 lazyload lazypreview" data-bgset="/images/cars/sonata/m_pics/03_performance/performance_slider_2.jpg [(max-width: 640px)] | /images/cars/sonata/tablet/performance_slider_2.jpg">
	</div>
	<div class="dynamics__head">
		<h2 class="dynamics__title"> <span>
		На рывок <br>
		 стремительнее. </span> </h2>
	...
	<ul class="s-parallax__list s-parallax__list--left">
		...
		<div class="s-parallax__description">
			 Поддержка Apple CarPlay Android и Auto. Управляйте своим телефоном с экрана мультимедиа системы с помощью тач-скрина или голосом. Используйте установленные приложения. Наслаждайтесь.
		</div>
 </li>
		...
		<div class="s-parallax__description">
			 Приборная панель Supervision с цветным дисплеем диагональю 4.2 дюйма отображает различную полезную информацию бортового компьютера, включая дальность поездки, максимальное расстояние до необходимой дозаправки и т.д.
		</div>
 </li>
		...
		<div class="s-parallax__description">
			 Система памяти настроек водительского сиденья (IMS) хранить в памяти настройки положения сиденья для двух водителей.
		</div>
 </li>
	</ul>
	<ul class="s-parallax__list s-parallax__list--right">
		...
		<div class="s-parallax__description">
			 Шторка на заднем стекте с электроприводом. Регулируйте затемнение заднего стекла с помощью электропривода шторки.
		</div>
 </li>
		...
		<div class="s-parallax__description">
			 Беспроводная система подзарядки теперь проще, чем когда-либо. Без неудобства. Без проводов.
		</div>
 </li>
		...
		<div class="s-parallax__description">
			 Подогрев передних и задних сидений в холодную погоду обеспечивает одинаково комфортные условия как для водителя, так и для остальных пассажиров.
		</div>
 </li>
	</ul>
	...
	<div data-bgset="/images/cars/i30n/m_pics/safety_1.jpg [(max-width: 640px)] | /images/cars/sonata/pics/5_tech/st.jpg" class="safety__back safety__back--1 lazyload lazypreview">
	</div>
 </section> <section class="section s-parallax safety safety--2">
	<div class="safety__head">
