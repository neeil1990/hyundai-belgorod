                        ...
                        <nav class="pip-primary-nav" role="navigation">
                            <div class="pip-primary-nav-w">
                                <ul class="pip-primary-nav-list">
                                    ...
                                    <li class="pip-primary-nav-item pip-primary-nav-item--to-outside"><a href="/configurator/" target="_blank" class="pip-primary-nav-link">Цены и кредит<svg xmlns="http://www.w3.org/2000/svg" class="svg arrow-right-w-tail"><use xlink:href="#arrow-right-w-tail"></use></svg></a></li>
                                </ul>
                            </div>
